...
def parse_args():
    ...
    # Model
    parser.add_argument("--from_pretrained", default="/home/xinyi/volta/checkpoints/mmdata/ctrl_vilbert/RetrievalMMdata_ctrl_vilbert_base/pytorch_model_9.bin", type=str,
                        help="Bert pre-trained model selected in the list: bert-base-uncased, "
                             "bert-large-uncased, bert-base-cased, bert-base-multilingual, bert-base-chinese.")
    parser.add_argument("--is_m3p", action='store_true', default=False,
                        help="Use M3P.")
    parser.add_argument("--config_file", default="/home/xinyi/volta/config/ctrl_vilbert_base.json", type=str,
                        help="The config file which specified the model details.")
    parser.add_argument("--resume_file", default="", type=str,
                        help="Resume from checkpoint")
    # Output
    parser.add_argument("--output_dir", default="/home/xinyi/volta/exmaple_xinyi_flick30/checkpoints/ctrl_vilbert", type=str,
                        help="The output directory where the model checkpoints will be written.")
    parser.add_argument("--logdir", default="/home/xinyi/volta/exmaple_xinyi_flick30/logs", type=str,
    ...
    parser.add_argument("--tasks_config_file", default="/home/xinyi/volta/exmaple_xinyi_flick30/ctrl_trainval_tasks.yml", type=str,
    ...
    parser.add_argument("--adam_correct_bias", default=True, action='store_true',
