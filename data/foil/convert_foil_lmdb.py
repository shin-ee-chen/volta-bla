...
def parse_args():
    ...
    parser.add_argument('--indir', type=str, default='/root/autodl-tmp/datasets/FOIL')
    # data/mscoco/imgfeats')
    parser.add_argument('--outdir', type=str, default='/root/autodl-tmp/datasets/FOIL/imgfeats/volta')
    parser.add_argument('--split', type=str, default='foil', choices=['coco-vist', 'coco', 'vist', 'genome', 'foil'])
...
if __name__ == '__main__':
    ...
    elif args.split == 'foil':
        args.infiles = [os.path.join(args.indir, "foil-imgs-features.tsv")]
