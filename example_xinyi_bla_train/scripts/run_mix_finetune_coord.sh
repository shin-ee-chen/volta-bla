...
#SBATCH --nodes=1
#SBATCH --job-name=bla_mix_coord_finetune_cls
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18
#SBATCH --gpus=1
#SBATCH --partition=gpu
#SBATCH --time=02:00:00
#SBATCH --output=bla_mix_coord_finetune_cls.out
...
TASK_TYPE=ctrl_bla_mix_coord_tasks
...
VILBERT_OUTPUT_DIR=/home/xchen/volta-bla/example_xinyi_bla_train/results/${VILBERT_MODEL}/mix
