...
#SBATCH --nodes=1
#SBATCH --job-name=bla_rc_finetune_16
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=18
#SBATCH --gpus=1
#SBATCH --partition=gpu
#SBATCH --time=01:00:00
#SBATCH --output=bla_rc_finetune_cls.out
...
VILBERT_OUTPUT_DIR=/home/xchen/volta-bla/example_xinyi_bla_train/results/${VILBERT_MODEL}/rc
